...
-- ============================================================
-- Enable Serial execution parameters-----
...
-- on Node_A and ONE remote row into Report@proj_link (or Incident@proj_link);
-- then COMMIT or ROLLBACK together to simulate a two-phase commit.
...
-- STEP 1: Verify system is clean before running a new test on both node
...
--2. Insert 8–10 domain facts relevant 
---to your project (e.g., simple type hierarchy or rule implications).
